...
class DataPoint(BaseModel):
    ...
    @classmethod
    def dummy(cls) -> "DataPoint":
        return cls(coordinates=(0.0, 0.0))
...
class Dataset(BaseModel):
    ...
    @classmethod
    def dummy(cls) -> "Dataset":
        return cls(data_points=(DataPoint.dummy(), DataPoint.dummy()))
...
class NeuralNetwork(BaseModel):
    ...
    @classmethod
    def dummy(cls) -> "NeuralNetwork":
        return cls(neurons=(Neuron.dummy(), Neuron.dummy()))
...
class LearningStrategy(BaseModel, ABC):
    ...
    @abstractmethod
    def choose_neurons(
        self, data_point: DataPoint, neurons: Tuple[Neuron, ...]
    ) -> Tuple[Neuron, ...]:
        pass
    ...
    def dummy(cls) -> "LearningStrategy":
        return DummyStrategy(proximity_function=lambda x: x, learning_rate=lambda x: x)
...
class DummyStrategy(LearningStrategy):
    ...
    def uptate_neurons_weights(self, neurons: Tuple[Neuron, ...]) -> None:
        for neuron in neurons:
            neuron.update_weights((0, 0))

    @classmethod
    def dummy(cls) -> "DummyStrategy":
        return cls(proximity_function=lambda x: x, learning_rate=lambda x: x)
...
class FSCLStrategy(LearningStrategy):
    @classmethod
    def dummy(cls) -> "FSCLStrategy":
        return cls(proximity_function=lambda x: x, learning_rate=lambda x: x)


class SOMStrategy(LearningStrategy):
    @classmethod
    def dummy(cls) -> "SOMStrategy":
        return cls(proximity_function=lambda x: x, learning_rate=lambda x: x)
...
class Experiment(BaseModel):
    ...
    @classmethod
    def dummy(cls) -> "Experiment":
        return cls(
            learning_strategy=LearningStrategy.dummy(),
            neural_network=NeuralNetwork.dummy(),
...
class ExperimentFactory(BaseModel):
    ...
    @classmethod
    def dummy(cls) -> "ExperimentFactory":
        return cls()
